...
(`bigIpRuntimeInitPackageUrl`)|`https://cdn.f5.com/product/cloudsolutions/f5-bigip-runtime-init/v1.4.0/dist/f5-bigip-runtime-init-1.4.0-1.gz.run`|Supply a URL for the F5 BIG-IP Runtime Init Package install script.|CFE S3 bucket
